...
EthStatus.prototype.getPending = function()
{
	var self = this;
	var now = _.now();
...
EthStatus.prototype.getHistory = function (range)
{
	var self = this;
...
EthStatus.prototype.sendStatsUpdate = function (force) {
  if (this.changed() || force) {
    console.sstats("wsc", "Sending", chalk.reset.blue((force ? "forced" : "changed")), chalk.bold.white("update"));
...
EthStatus.prototype.prepareBlock = function ()
{
	return {
		id: this.id,
...
EthStatus.prototype.preparePending = function ()
{
	return {
		id: this.id,
		stats: {
...
//// TODO: emitters do something else...  
...
//// TODO: fix emitter
EthStatus.prototype.sendBlockUpdate = function()
{
	this._lastBlockSentAt = _.now();
	console.sstats("wsc", "Sending", chalk.reset.red("block"), chalk.bold.white("update"));
	//this.emit('block', this.prepareBlock());
}

//// TODO: fix emitter
EthStatus.prototype.sendPendingUpdate = function()
{
...
EthStatus.prototype.validateLatestBlock = function (error, result, timeString)
{
...
EthStatus.prototype.formatBlock = function (block)
{
...
EthStatus.prototype.currentStats = function () {
  return flatten({ "id": this.id, "info": this.info, "stats": this.stats });
}
...
EthStatus.prototype.reconnectWeb3 = function()
{
...
EthStatus.prototype.setInactive = function()
{
